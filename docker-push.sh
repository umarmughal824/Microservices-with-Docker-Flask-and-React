...
then
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-444838262.us-east-1.elb.amazonaws.com"
    export REACT_APP_SCORES_SERVICE_URL="http://testdriven-staging-alb-444838262.us-east-1.elb.amazonaws.com"
